...
npx mcporter call "xiaohongshu-mcp.publish_content(account_id: 'botX', title: '标题', content: '内容', images: ['url'])"
```
...
```bash
npx mcporter call "xiaohongshu-mcp.publish_content(account_id: 'botX', title: '春日出游指南', content: '...正文...', text_to_image: true)"
```

### 定时发布示例

```bash
npx mcporter call "xiaohongshu-mcp.publish_content(account_id: 'botX', title: '..', content: '..', images: ['/path/img.jpg'], schedule_at: '2025-12-01T10:00:00+08:00')"
```
