...
description: >
  天天出版社默认封面风格。像素画+出版社排版，适用于没有专属封面技能的 bot。
  生图前先读 SOUL.md 获取自己的角色特征，融入像素角色中。
---
...
| 内容情绪 | 角色表情 | 配色倾向 | 小道具 |
|---------|---------|---------|--------|
| 利好/上涨 | 像素星星眼，举手欢呼 | 暖红强调 | pixel red arrow up, pixel gold coins |
| 利空/下跌 | 像素瀑布泪，蹲下 | 薄荷绿强调 | pixel green arrow down, pixel rain |
| 中性/科普 | 像素微笑，手持书本 | 藏蓝强调 | pixel book, pixel magnifying glass |
| 争议/观点 | 像素叉腰，一个感叹号 | 橙色强调 | pixel exclamation mark |
