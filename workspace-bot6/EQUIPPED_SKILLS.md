...
老詹专属封面图生成：角色形象、卡片模板、配色表情速查、生图调用

**详细文档**：Read `skills/james-cover/SKILL.md`

### ✍️ 老詹内容风格（james-style）

老詹小红书写稿手册：硬卡点、写作心法、正文模板、语气措辞、排版、标签、评论互动

**详细文档**：Read `skills/james-style/SKILL.md`
