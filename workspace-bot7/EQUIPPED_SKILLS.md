...
### ✍️ 大E飞风格（dae-fly-style）

犀利直接、数据驱动的投研写作风格

**详细文档**：Read `skills/dae-fly-style/SKILL.md`

### 🎴 老K画图风格（laok-style）

老K投资笔记 IP 形象与配图风格 prompt 模板，用于 image-generator 生成统一视觉风格的配图

**详细文档**：Read `skills/laok-style/SKILL.md`
...
**详细文档**：Read `skills/deepreasearch/SKILL.md`
