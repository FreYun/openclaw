...
记录 market-regime-classifier 在真实复盘数据上的判断结果，用于校准阈值、解释行为、发现边缘情况。

数据源：[workspace-bot11/memory/review-output/](../../../../workspace-bot11/memory/review-output/) 的真实复盘 + classify 输出。决策日志：[memory/regime-log.md](../memory/regime-log.md)。
