...
你的小红书 MCP 服务端口是 **18064**（容器 `xiaohongshu-mcp-4`，端点 `http://localhost:18064/mcp`）。所有小红书操作（登录、发帖、浏览、搜索、互动等）**必须参考 `skills/xiaohongshu-mcp/SKILL.md`**，按其中的工具说明和参数要求调用，不要凭记忆猜测。
