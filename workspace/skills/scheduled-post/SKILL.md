...
DRAFT_DIR="/home/rooot/.openclaw/workspace-{botN}/draft-review/pending/$(date +%Y-%m-%dT%H-%M-%S)_{botN}_$(head /dev/urandom | tr -dc a-z0-9 | head -c6)"
mkdir -p "$DRAFT_DIR"
...
```bash
# 从 post.md 提取字段构建参数
BODY_FILE="/home/rooot/.openclaw/workspace-{botN}/temp/{botN}-draft-$$.txt"
mkdir -p /home/rooot/.openclaw/workspace-{botN}/temp
