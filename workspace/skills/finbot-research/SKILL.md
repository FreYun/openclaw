...
**工具**：
- browser 搜索：`"{公司名} 商业模式 收入结构"` / `"{company} business model revenue breakdown"`
- A股补充：`tushare_stock_basic(ts_code)`
...
## 投资结论
- 论点状态：✅ CONFIRMED / ⚠️ UNDER REVIEW / ❌ BROKEN
- 目标价：¥/$ X（当前 ¥/$ Y，上行空间 Z%）
- 估值区间：¥/$ Low — ¥/$ High
- 核心逻辑（3句话）
...
### 投资论点状态
✅ CONFIRMED / ⚠️ UNDER REVIEW / ❌ BROKEN
**理由**：...
```
...
- **时效标注**：所有数据标注来源和 🟢/🟡/🔴
- **论点必须表态**：CONFIRMED / UNDER REVIEW / BROKEN，不可模棱两可
