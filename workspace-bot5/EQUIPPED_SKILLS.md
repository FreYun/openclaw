...
宣妈专属封面图生成：角色形象、卡片/写实两套模板、配色表情速查、生图调用

**详细文档**：Read `skills/xuanma-cover/SKILL.md`

### ✍️ 宣妈内容风格（xuanma-style）

宣妈小红书内容形式与风格规范：日常简评、月度复盘、排版、封面、通用红线

**详细文档**：Read `skills/xuanma-style/SKILL.md`
